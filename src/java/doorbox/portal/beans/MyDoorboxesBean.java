...
@ViewScoped
@ManagedBean
public class MyDoorboxesBean extends BaseBean {
    ...
    public void onRowUnselect(UnselectEvent event) {
        FacesMessage msg = new FacesMessage("Dpprbpx Unselected", ((Doorbox) event.getObject()).getDoorboxId().toString());
        FacesContext.getCurrentInstance().addMessage(null, msg);
    }
    ...
    */
    public void read() {
        Query q = em.createNamedQuery("Doorbox.findByAccountId");
        Integer accountId = getSessionBean().getAccount().getAccountId();
