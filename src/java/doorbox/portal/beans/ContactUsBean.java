...
public class ContactUsBean extends BaseBean {
    ...
    @NotNull(message = "Required")
    @Size(min = 1, max = 1000, message = "Between 1 and 1000 characters")
    ...
    public String sendMessage() {
        ...
        try {
            ...
            EmailTemplateBean.sendTemplateEmail("sales@thedoorbox.com", "Customer Inquiry", "emailTemplate_contactUs.xhtml", map);
            
            return "contacted.xhtml";
        } catch (Exception e) {
